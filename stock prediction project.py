...
#tcs
data1=pd.read_csv("D:\\projects\\stockProject\\tcs.csv")
# print(data)
...
#itc
data2=pd.read_csv('D:\\projects\\stockProject\\itc.csv')
# print(data)
...
data3=pd.read_csv('D:\\projects\\stockProject\\infosys.csv')
# print(data3)
...
#hdfc
data4=pd.read_csv('D:\\projects\\stockProject\\hdfc.csv')
# print(data4)
...
#reliance
data5=pd.read_csv('D:\\projects\\stockProject\\reliance.csv')
# print(data5)
...
def display_plot():
    ...
    if selected_option == "ITC":
        ...
        plt.xlabel('Time')
        plt.ylabel('Value')
        plt.title('Infosys Stock predict')
        plt.legend()
        plt.show()
        ...
        plt.xlabel('Time')
        plt.ylabel('Value')
        plt.title('Reliance Stock predict')
        plt.legend()
        plt.show()
